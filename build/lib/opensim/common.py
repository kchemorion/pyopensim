...
class OpenSimException(object):
    ...
    def __init__(self, *args):
        ...
        __init__(OpenSimException self, std::string const & file, size_t line, std::string const & func, OpenSimObject obj, std::string const & msg) -> OpenSimException
...
def interpolate(x, y, newX, ignoreNaNs=False):
    r"""
    interpolate(Vector x, Vector y, Vector newX, bool const ignoreNaNs=False) -> Vector
...
def Logger_setLevel(level):
    r"""
    Logger_setLevel(OpenSim::Logger::Level level)
...
def Logger_getLevel():
    r"""Logger_getLevel() -> OpenSim::Logger::Level"""
    return _common.Logger_getLevel()

def Logger_setLevelString(level):
    r"""
    Logger_setLevelString(std::string level)
...
def Logger_getLevelString():
    r"""Logger_getLevelString() -> std::string"""
    return _common.Logger_getLevelString()

def Logger_shouldLog(level):
    r"""
    Logger_shouldLog(OpenSim::Logger::Level level) -> bool
...
def Logger_addFileSink(*args):
    r"""
    Logger_addFileSink(std::string const & filepath="opensim.log")
...
def Logger_removeFileSink():
    r"""Logger_removeFileSink()"""
    return _common.Logger_removeFileSink()

def Logger_addSink(sink):
    r"""
    Logger_addSink(std::shared_ptr< OpenSim::LogSink > const sink)
...
def Logger_removeSink(sink):
    r"""
    Logger_removeSink(std::shared_ptr< OpenSim::LogSink > const sink)
...
class PropertyString(AbstractProperty):
    ...
    def clone(self):
        r"""clone(PropertyString self) -> PropertyString"""
        return _common.PropertyString_clone(self)

    def getTypeName(self):
        r"""getTypeName(PropertyString self) -> std::string"""
...
def OpenSimObject_PrintPropertyInfo(*args):
    r"""
    OpenSimObject_PrintPropertyInfo(std::ostream & os, std::string const & classNameDotPropertyName, bool printFlagInfo=True) -> bool
    ...
    OpenSimObject_PrintPropertyInfo(std::ostream & os, std::string const & className, std::string const & propertyName, bool printFlagInfo=True) -> bool
...
def OpenSimObject_getClassName():
    r"""OpenSimObject_getClassName() -> std::string const &"""
    return _common.OpenSimObject_getClassName()
...
def OpenSimObject_getSerializeAllDefaults():
    r"""OpenSimObject_getSerializeAllDefaults() -> bool"""
    return _common.OpenSimObject_getSerializeAllDefaults()
...
def OpenSimObject_getDebugLevel():
    r"""OpenSimObject_getDebugLevel() -> int"""
    return _common.OpenSimObject_getDebugLevel()
...
def ObjectGroup_getClassName():
    r"""ObjectGroup_getClassName() -> std::string const &"""
    return _common.ObjectGroup_getClassName()
...
def PropertyHelper_getValueBool(p, index=-1):
    r"""
    PropertyHelper_getValueBool(AbstractProperty p, int index=-1) -> bool
...
def PropertyHelper_setValueBool(v, p, index=-1):
    r"""
    PropertyHelper_setValueBool(bool v, AbstractProperty p, int index=-1)
...
def PropertyHelper_getValueInt(p, index=-1):
    r"""
    PropertyHelper_getValueInt(AbstractProperty p, int index=-1) -> int
...
def PropertyHelper_setValueInt(v, p, index=-1):
    r"""
    PropertyHelper_setValueInt(int v, AbstractProperty p, int index=-1)
...
def PropertyHelper_getValueDouble(p, index=-1):
    r"""
    PropertyHelper_getValueDouble(AbstractProperty p, int index=-1) -> double
...
def PropertyHelper_setValueDouble(v, p, index=-1):
    r"""
    PropertyHelper_setValueDouble(double v, AbstractProperty p, int index=-1)
...
def PropertyHelper_getValueString(p, index=-1):
    r"""
    PropertyHelper_getValueString(AbstractProperty p, int index=-1) -> std::string
...
def PropertyHelper_setValueString(v, p, index=-1):
    r"""
    PropertyHelper_setValueString(std::string const & v, AbstractProperty p, int index=-1)
...
def PropertyHelper_getValueVec6(p, index):
    r"""
    PropertyHelper_getValueVec6(AbstractProperty p, int index) -> double
...
def PropertyHelper_setValueVec6(v, p, index):
    r"""
    PropertyHelper_setValueVec6(double v, AbstractProperty p, int index)
...
def OpenSimObjectSet_getClassName():
    r"""OpenSimObjectSet_getClassName() -> std::string const &"""
    return _common.OpenSimObjectSet_getClassName()
...
class ArrayStateVector(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayStateVector self, StateVector aDefaultValue=OpenSim::StateVector(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayStateVector
        ...
        __init__(ArrayStateVector self, ArrayStateVector aArray) -> ArrayStateVector
...
def StorageInterface_getClassName():
    r"""StorageInterface_getClassName() -> std::string const &"""
    return _common.StorageInterface_getClassName()
...
def IO_ConstructDateAndTimeStamp():
    r"""IO_ConstructDateAndTimeStamp() -> char *"""
    return _common.IO_ConstructDateAndTimeStamp()
...
def IO_GetGFormatForDoubleOutput():
    r"""IO_GetGFormatForDoubleOutput() -> bool"""
    return _common.IO_GetGFormatForDoubleOutput()
...
def IO_GetPrecision():
    r"""IO_GetPrecision() -> int"""
    return _common.IO_GetPrecision()

def IO_GetDoubleOutputFormat():
    r"""IO_GetDoubleOutputFormat() -> char const *"""
    return _common.IO_GetDoubleOutputFormat()
...
def IO_GetPrintOfflineDocuments():
    r"""IO_GetPrintOfflineDocuments() -> bool"""
    return _common.IO_GetPrintOfflineDocuments()
...
def IO_formatText(*args):
    r"""
    IO_formatText(std::string const & aComment, std::string const & leadingWhitespace, int width, std::string const & endlineTokenToInsert="\n") -> std::string
...
def IO_StartsWith(string, start):
    r"""
    IO_StartsWith(std::string const & string, std::string const & start) -> bool
...
def IO_EndsWith(string, ending):
    r"""
    IO_EndsWith(std::string const & string, std::string const & ending) -> bool
...
def IO_StartsWithIgnoringCase(string, start):
    r"""
    IO_StartsWithIgnoringCase(std::string const & string, std::string const & start) -> bool
...
def IO_EndsWithIgnoringCase(string, ending):
    r"""
    IO_EndsWithIgnoringCase(std::string const & string, std::string const & ending) -> bool
...
def Function_getClassName():
    r"""Function_getClassName() -> std::string const &"""
    return _common.Function_getClassName()
...
def SetFunctions_getClassName():
    r"""SetFunctions_getClassName() -> std::string const &"""
    return _common.SetFunctions_getClassName()
...
def FunctionSet_getClassName():
    r"""FunctionSet_getClassName() -> std::string const &"""
    return _common.FunctionSet_getClassName()
...
def Constant_getClassName():
    r"""Constant_getClassName() -> std::string const &"""
    return _common.Constant_getClassName()
...
def SimmSpline_getClassName():
    r"""SimmSpline_getClassName() -> std::string const &"""
    return _common.SimmSpline_getClassName()
...
def StepFunction_getClassName():
    r"""StepFunction_getClassName() -> std::string const &"""
    return _common.StepFunction_getClassName()
...
def PiecewiseConstantFunction_getClassName():
    r"""PiecewiseConstantFunction_getClassName() -> std::string const &"""
    return _common.PiecewiseConstantFunction_getClassName()
...
def LinearFunction_getClassName():
    r"""LinearFunction_getClassName() -> std::string const &"""
    return _common.LinearFunction_getClassName()
...
def PiecewiseLinearFunction_getClassName():
    r"""PiecewiseLinearFunction_getClassName() -> std::string const &"""
    return _common.PiecewiseLinearFunction_getClassName()
...
def MultiplierFunction_getClassName():
    r"""MultiplierFunction_getClassName() -> std::string const &"""
    return _common.MultiplierFunction_getClassName()
...
def GCVSpline_getClassName():
    r"""GCVSpline_getClassName() -> std::string const &"""
    return _common.GCVSpline_getClassName()
...
def Sine_getClassName():
    r"""Sine_getClassName() -> std::string const &"""
    return _common.Sine_getClassName()
...
def PolynomialFunction_getClassName():
    r"""PolynomialFunction_getClassName() -> std::string const &"""
    return _common.PolynomialFunction_getClassName()
...
def MultivariatePolynomialFunction_safeDownCast(obj):
    r"""
    MultivariatePolynomialFunction_safeDownCast(OpenSimObject obj) -> MultivariatePolynomialFunction
...
def MultivariatePolynomialFunction_getClassName():
    r"""MultivariatePolynomialFunction_getClassName() -> std::string const &"""
    return _common.MultivariatePolynomialFunction_getClassName()
...
class SmoothSegmentedFunction(object):
    ...
    def __init__(self):
        r"""__init__(SmoothSegmentedFunction self) -> SmoothSegmentedFunction"""
...
def XYFunctionInterface_getClassName():
    r"""XYFunctionInterface_getClassName() -> std::string const &"""
    return _common.XYFunctionInterface_getClassName()
...
class ArrayXYPoint(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayXYPoint self, XYPoint aDefaultValue=OpenSim::XYPoint(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayXYPoint
        ...
        __init__(ArrayXYPoint self, ArrayXYPoint aArray) -> ArrayXYPoint
...
class ArrayBool(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayBool self, bool const & aDefaultValue=bool(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayBool
        ...
        __init__(ArrayBool self, ArrayBool aArray) -> ArrayBool
...
class ArrayDouble(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayDouble self, double const & aDefaultValue=double(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayDouble
        ...
        __init__(ArrayDouble self, ArrayDouble aArray) -> ArrayDouble
...
def ArrayDouble_createVec3(*args):
    r"""
    ArrayDouble_createVec3(double e1, double e2, double e3) -> Vec3
    ...
    ArrayDouble_createVec3(double e1) -> Vec3
...
class ArrayInt(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayInt self, int const & aDefaultValue=int(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayInt
        ...
        __init__(ArrayInt self, ArrayInt aArray) -> ArrayInt
...
class ArrayStr(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayStr self, std::string const & aDefaultValue=std::string(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayStr
        ...
        __init__(ArrayStr self, ArrayStr aArray) -> ArrayStr
...
class ArrayVec3(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayVec3 self, Vec3 aDefaultValue=SimTK::Vec< 3,double,1 >(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayVec3
        ...
        __init__(ArrayVec3 self, ArrayVec3 aArray) -> ArrayVec3
...
class ArrayObjPtr(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayObjPtr self, OpenSimObject aDefaultValue=OpenSim::Object *(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayObjPtr
        ...
        __init__(ArrayObjPtr self, ArrayObjPtr aArray) -> ArrayObjPtr
...
class ArrayConstObjPtr(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(ArrayConstObjPtr self, OpenSimObject aDefaultValue=OpenSim::Object const *(), int aSize=0, int aCapacity=Array_CAPMIN) -> ArrayConstObjPtr
        ...
        __init__(ArrayConstObjPtr self, ArrayConstObjPtr aArray) -> ArrayConstObjPtr
...
def ModelDisplayHints_getClassName():
    r"""ModelDisplayHints_getClassName() -> std::string const &"""
    return _common.ModelDisplayHints_getClassName()
...
class AbstractSocket(object):
    ...
    def getConnecteeAsObject(self):
        r"""getConnecteeAsObject(AbstractSocket self) -> OpenSimObject"""
...
class ComponentPath(object):
    ...
    def __init__(self, *args):
        ...
        __init__(ComponentPath self, std::string path) -> ComponentPath
    ...
    def __eq__(self, arg2):
        r"""
        __eq__(ComponentPath self, ComponentPath arg2) -> bool

        Parameters
        ----------
        arg2: OpenSim::ComponentPath const &
    ...
    def __ne__(self, arg2):
        r"""
        __ne__(ComponentPath self, ComponentPath arg2) -> bool
    ...
    def toString(self):
        r"""toString(ComponentPath self) -> std::string"""
...
class ComponentHasNoName(OpenSimException):
    ...
    def __init__(self, file, line, func, componentConcreteClassName):
        r"""
        __init__(ComponentHasNoName self, std::string const & file, size_t line, std::string const & func, std::string const & componentConcreteClassName) -> ComponentHasNoName
...
class InvalidComponentName(OpenSimException):
    ...
    def __init__(self, file, line, func, thisName, invalidChars, componentConcreteClassName):
        r"""
        __init__(InvalidComponentName self, std::string const & file, size_t line, std::string const & func, std::string const & thisName, std::string const & invalidChars, std::string const & componentConcreteClassName) -> InvalidComponentName
...
class ComponentNotFoundOnSpecifiedPath(ComponentNotFound):
    ...
    def __init__(self, file, line, func, toFindName, toFindClassName, thisName):
        r"""
        __init__(ComponentNotFoundOnSpecifiedPath self, std::string const & file, size_t line, std::string const & func, std::string const & toFindName, std::string const & toFindClassName, std::string const & thisName) -> ComponentNotFoundOnSpecifiedPath
...
class ComponentIsAnOrphan(OpenSimException):
    ...
    def __init__(self, file, line, func, thisName, componentConcreteClassName):
        r"""
        __init__(ComponentIsAnOrphan self, std::string const & file, size_t line, std::string const & func, std::string const & thisName, std::string const & componentConcreteClassName) -> ComponentIsAnOrphan
...
class SubcomponentsWithDuplicateName(OpenSimException):
    ...
    def __init__(self, file, line, func, thisName, duplicateName):
        r"""
        __init__(SubcomponentsWithDuplicateName self, std::string const & file, size_t line, std::string const & func, std::string const & thisName, std::string const & duplicateName) -> SubcomponentsWithDuplicateName
...
class ComponentIsRootWithNoSubcomponents(OpenSimException):
    ...
    def __init__(self, file, line, func, thisName, componentConcreteClassName):
        r"""
        __init__(ComponentIsRootWithNoSubcomponents self, std::string const & file, size_t line, std::string const & func, std::string const & thisName, std::string const & componentConcreteClassName) -> ComponentIsRootWithNoSubcomponents
...
class ComponentAlreadyPartOfOwnershipTree(OpenSimException):
    ...
    def __init__(self, file, line, func, compName, thisName):
        r"""
        __init__(ComponentAlreadyPartOfOwnershipTree self, std::string const & file, size_t line, std::string const & func, std::string const & compName, std::string const & thisName) -> ComponentAlreadyPartOfOwnershipTree
...
class ComponentHasNoSystem(OpenSimException):
    ...
    def __init__(self, file, line, func, obj):
        r"""
        __init__(ComponentHasNoSystem self, std::string const & file, size_t line, std::string const & func, OpenSimObject obj) -> ComponentHasNoSystem
...
class SocketNotFound(OpenSimException):
    ...
    def __init__(self, file, line, func, obj, socketName):
        r"""
        __init__(SocketNotFound self, std::string const & file, size_t line, std::string const & func, OpenSimObject obj, std::string const & socketName) -> SocketNotFound
...
class InputNotFound(OpenSimException):
    ...
    def __init__(self, file, line, func, obj, inputName):
        r"""
        __init__(InputNotFound self, std::string const & file, size_t line, std::string const & func, OpenSimObject obj, std::string const & inputName) -> InputNotFound
...
class OutputNotFound(OpenSimException):
    ...
    def __init__(self, file, line, func, obj, outputName):
        r"""
        __init__(OutputNotFound self, std::string const & file, size_t line, std::string const & func, OpenSimObject obj, std::string const & outputName) -> OutputNotFound
...
def Component_getClassName():
    r"""Component_getClassName() -> std::string const &"""
    return _common.Component_getClassName()
...
def Scale_getClassName():
    r"""Scale_getClassName() -> std::string const &"""
    return _common.Scale_getClassName()
...
def SetScales_getClassName():
    r"""SetScales_getClassName() -> std::string const &"""
    return _common.SetScales_getClassName()
...
def ScaleSet_getClassName():
    r"""ScaleSet_getClassName() -> std::string const &"""
    return _common.ScaleSet_getClassName()
...
def MarkerFrame_getClassName():
    r"""MarkerFrame_getClassName() -> std::string const &"""
    return _common.MarkerFrame_getClassName()
...
def MarkerData_getClassName():
    r"""MarkerData_getClassName() -> std::string const &"""
    return _common.MarkerData_getClassName()
...
def TableUtilities_checkNonUniqueLabels(labels):
    r"""
    TableUtilities_checkNonUniqueLabels(StdVectorString labels)
...
def TableUtilities_isInDegrees(table):
    r"""
    TableUtilities_isInDegrees(TimeSeriesTable table) -> bool
...
def TableUtilities_findStateLabelIndex(*args):
    r"""
    TableUtilities_findStateLabelIndex(ArrayStr labels, std::string const & desired) -> int
    ...
    TableUtilities_findStateLabelIndex(StdVectorString labels, std::string const & desired) -> int
...
def TableUtilities_filterLowpass(table, cutoffFreq, padData=False):
    r"""
    TableUtilities_filterLowpass(TimeSeriesTable table, double cutoffFreq, bool padData=False)
...
def TableUtilities_pad(table, numRowsToPrependAndAppend):
    r"""
    TableUtilities_pad(TimeSeriesTable table, int numRowsToPrependAndAppend)
...
def TableUtilities_convertRotationsToEulerAngles(rotTable):
    r"""
    TableUtilities_convertRotationsToEulerAngles(OpenSim::TimeSeriesTable_< SimTK::Rotation > const & rotTable) -> TimeSeriesTableVec3
...
def ExperimentalSensor_getClassName():
    r"""ExperimentalSensor_getClassName() -> std::string const &"""
    return _common.ExperimentalSensor_getClassName()
...
def XsensDataReaderSettings_getClassName():
    r"""XsensDataReaderSettings_getClassName() -> std::string const &"""
    return _common.XsensDataReaderSettings_getClassName()
...
class TableMissingHeader(OpenSimException):
    ...
    def __init__(self, file, line, func):
        r"""
        __init__(TableMissingHeader self, std::string const & file, size_t line, std::string const & func) -> TableMissingHeader
...
def APDMDataReaderSettings_getClassName():
    r"""APDMDataReaderSettings_getClassName() -> std::string const &"""
    return _common.APDMDataReaderSettings_getClassName()
...
def TableSource_getClassName():
    r"""TableSource_getClassName() -> std::string const &"""
    return _common.TableSource_getClassName()
...
def TableSourceVec3_getClassName():
    r"""TableSourceVec3_getClassName() -> std::string const &"""
    return _common.TableSourceVec3_getClassName()
...
def AbstractReporter_getClassName():
    r"""AbstractReporter_getClassName() -> std::string const &"""
    return _common.AbstractReporter_getClassName()
...
class ReporterDouble(AbstractReporter):
    ...
    PropertyIndex_input_inputs = property(_common.ReporterDouble_PropertyIndex_input_inputs_get, _common.ReporterDouble_PropertyIndex_input_inputs_set, doc=r"""PropertyIndex_input_inputs : PropertyIndex""")
...
def ReporterDouble_getClassName():
    r"""ReporterDouble_getClassName() -> std::string const &"""
    return _common.ReporterDouble_getClassName()
...
class ReporterVec3(AbstractReporter):
    ...
    PropertyIndex_input_inputs = property(_common.ReporterVec3_PropertyIndex_input_inputs_get, _common.ReporterVec3_PropertyIndex_input_inputs_set, doc=r"""PropertyIndex_input_inputs : PropertyIndex""")
...
def ReporterVec3_getClassName():
    r"""ReporterVec3_getClassName() -> std::string const &"""
    return _common.ReporterVec3_getClassName()
...
class ReporterVector(AbstractReporter):
    ...
    PropertyIndex_input_inputs = property(_common.ReporterVector_PropertyIndex_input_inputs_get, _common.ReporterVector_PropertyIndex_input_inputs_set, doc=r"""PropertyIndex_input_inputs : PropertyIndex""")
...
def ReporterVector_getClassName():
    r"""ReporterVector_getClassName() -> std::string const &"""
    return _common.ReporterVector_getClassName()
...
def TableReporter_getClassName():
    r"""TableReporter_getClassName() -> std::string const &"""
    return _common.TableReporter_getClassName()
...
def TableReporterVec3_getClassName():
    r"""TableReporterVec3_getClassName() -> std::string const &"""
    return _common.TableReporterVec3_getClassName()
...
def TableReporterSpatialVec_getClassName():
    r"""TableReporterSpatialVec_getClassName() -> std::string const &"""
    return _common.TableReporterSpatialVec_getClassName()
...
def TableReporterVector_getClassName():
    r"""TableReporterVector_getClassName() -> std::string const &"""
    return _common.TableReporterVector_getClassName()
...
def ConsoleReporter_getClassName():
    r"""ConsoleReporter_getClassName() -> std::string const &"""
    return _common.ConsoleReporter_getClassName()
...
def ConsoleReporterVec3_getClassName():
    r"""ConsoleReporterVec3_getClassName() -> std::string const &"""
    return _common.ConsoleReporterVec3_getClassName()
...
def GCVSplineSet_getClassName():
    r"""GCVSplineSet_getClassName() -> std::string const &"""
    return _common.GCVSplineSet_getClassName()
