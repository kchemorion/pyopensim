...
def Vec2_getDefaultTolerance():
    r"""Vec2_getDefaultTolerance() -> double"""
    return _simbody.Vec2_getDefaultTolerance()
...
def Vec3_getDefaultTolerance():
    r"""Vec3_getDefaultTolerance() -> double"""
    return _simbody.Vec3_getDefaultTolerance()

def Vec3_createFromMat(n):
    r"""
    Vec3_createFromMat(int n) -> Vec3
...
def Vec4_getDefaultTolerance():
    r"""Vec4_getDefaultTolerance() -> double"""
    return _simbody.Vec4_getDefaultTolerance()
...
def Vec6_getDefaultTolerance():
    r"""Vec6_getDefaultTolerance() -> double"""
    return _simbody.Vec6_getDefaultTolerance()
...
def Mat33_getDefaultTolerance():
    r"""Mat33_getDefaultTolerance() -> double"""
    return _simbody.Mat33_getDefaultTolerance()
...
def Matrix_createFromMat(nrow):
    r"""
    Matrix_createFromMat(int nrow) -> Matrix
...
def Vector_createFromMat(n):
    r"""
    Vector_createFromMat(int n) -> Vector
...
def RowVector_createFromMat(n):
    r"""
    RowVector_createFromMat(int n) -> RowVector
...
def SpatialVec_size():
    r"""SpatialVec_size() -> int"""
    return _simbody.SpatialVec_size()

def SpatialVec_nrow():
    r"""SpatialVec_nrow() -> int"""
    return _simbody.SpatialVec_nrow()

def SpatialVec_ncol():
    r"""SpatialVec_ncol() -> int"""
    return _simbody.SpatialVec_ncol()

def SpatialVec_getDefaultTolerance():
    r"""SpatialVec_getDefaultTolerance() -> double"""
    return _simbody.SpatialVec_getDefaultTolerance()
...
def Rotation_calcNForBodyXYZInBodyFrame(*args):
    r"""
    Rotation_calcNForBodyXYZInBodyFrame(Vec3 q) -> Mat33
...
def Rotation_calcNForBodyXYZInParentFrame(*args):
    r"""
    Rotation_calcNForBodyXYZInParentFrame(Vec3 q) -> Mat33
...
def Rotation_calcNDotForBodyXYZInBodyFrame(*args):
    r"""
    Rotation_calcNDotForBodyXYZInBodyFrame(Vec3 q, Vec3 qdot) -> Mat33
...
def Rotation_calcNDotForBodyXYZInParentFrame(*args):
    r"""
    Rotation_calcNDotForBodyXYZInParentFrame(Vec3 q, Vec3 qdot) -> Mat33
...
def Rotation_calcNInvForBodyXYZInBodyFrame(*args):
    r"""
    Rotation_calcNInvForBodyXYZInBodyFrame(Vec3 q) -> Mat33
...
def Rotation_calcNInvForBodyXYZInParentFrame(*args):
    r"""
    Rotation_calcNInvForBodyXYZInParentFrame(Vec3 q) -> Mat33
...
def Rotation_convertAngVelInBodyFrameToBodyXYZDot(*args):
    r"""
    Rotation_convertAngVelInBodyFrameToBodyXYZDot(Vec3 q, Vec3 w_PB_B) -> Vec3
...
def Rotation_convertBodyXYZDotToAngVelInBodyFrame(*args):
    r"""
    Rotation_convertBodyXYZDotToAngVelInBodyFrame(Vec3 q, Vec3 qdot) -> Vec3
...
def Rotation_convertAngVelDotInBodyFrameToBodyXYZDotDot(*args):
    r"""
    Rotation_convertAngVelDotInBodyFrameToBodyXYZDotDot(Vec3 q, Vec3 w_PB_B, Vec3 wdot_PB_B) -> Vec3
...
def ArrayIndexUnsigned_max_size():
    r"""ArrayIndexUnsigned_max_size() -> SimTK::ArrayIndexTraits< unsigned int >::size_type"""
    return _simbody.ArrayIndexUnsigned_max_size()
...
def ArrayIndexInt_max_size():
    r"""ArrayIndexInt_max_size() -> SimTK::ArrayIndexTraits< int >::size_type"""
    return _simbody.ArrayIndexInt_max_size()
...
def PolygonalMesh_createSphereMesh(radius, resolution=1):
    r"""
    PolygonalMesh_createSphereMesh(SimTK::Real radius, int resolution=1) -> PolygonalMesh
...
def PolygonalMesh_createBrickMesh(halfDims, resolution=1):
    r"""
    PolygonalMesh_createBrickMesh(Vec3 halfDims, int resolution=1) -> PolygonalMesh
...
def PolygonalMesh_createCylinderMesh(axis, radius, halfLength, resolution=1):
    r"""
    PolygonalMesh_createCylinderMesh(UnitVec3 axis, SimTK::Real radius, SimTK::Real halfLength, int resolution=1) -> PolygonalMesh
...
def SimbodyMatterSubsystem_isInstanceOf(arg1):
    r"""
    SimbodyMatterSubsystem_isInstanceOf(Subsystem const & arg1) -> bool
...
def SimbodyMatterSubsystem_downcast(arg1):
    r"""
    SimbodyMatterSubsystem_downcast(Subsystem const & arg1) -> SimbodyMatterSubsystem
...
def SimbodyMatterSubsystem_updDowncast(arg1):
    r"""
    SimbodyMatterSubsystem_updDowncast(Subsystem & arg1) -> SimbodyMatterSubsystem
