...
def CoordinateActuator_getClassName():
    r"""CoordinateActuator_getClassName() -> std::string const &"""
    return _actuators.CoordinateActuator_getClassName()
...
def CoordinateActuator_CreateForceSetOfCoordinateActuatorsForModel(s, aModel, aOptimalForce=1, aIncludeLockedAndConstrainedCoordinates=True):
    r"""
    CoordinateActuator_CreateForceSetOfCoordinateActuatorsForModel(State s, Model aModel, double aOptimalForce=1, bool aIncludeLockedAndConstrainedCoordinates=True) -> ForceSet
...
def ActivationCoordinateActuator_getClassName():
    r"""ActivationCoordinateActuator_getClassName() -> std::string const &"""
    return _actuators.ActivationCoordinateActuator_getClassName()
...
def PointActuator_getClassName():
    r"""PointActuator_getClassName() -> std::string const &"""
    return _actuators.PointActuator_getClassName()
...
def TorqueActuator_getClassName():
    r"""TorqueActuator_getClassName() -> std::string const &"""
    return _actuators.TorqueActuator_getClassName()
...
class BodyActuator(opensim.simulation.Actuator):
    ...
    PropertyIndex_socket_body = property(_actuators.BodyActuator_PropertyIndex_socket_body_get, _actuators.BodyActuator_PropertyIndex_socket_body_set, doc=r"""PropertyIndex_socket_body : PropertyIndex""")
...
def BodyActuator_getClassName():
    r"""BodyActuator_getClassName() -> std::string const &"""
    return _actuators.BodyActuator_getClassName()
...
def PointToPointActuator_getClassName():
    r"""PointToPointActuator_getClassName() -> std::string const &"""
    return _actuators.PointToPointActuator_getClassName()
...
def ClutchedPathSpring_getClassName():
    r"""ClutchedPathSpring_getClassName() -> std::string const &"""
    return _actuators.ClutchedPathSpring_getClassName()
...
def SpringGeneralizedForce_getClassName():
    r"""SpringGeneralizedForce_getClassName() -> std::string const &"""
    return _actuators.SpringGeneralizedForce_getClassName()
...
def RigidTendonMuscle_getClassName():
    r"""RigidTendonMuscle_getClassName() -> std::string const &"""
    return _actuators.RigidTendonMuscle_getClassName()
...
def Millard2012AccelerationMuscle_getClassName():
    r"""Millard2012AccelerationMuscle_getClassName() -> std::string const &"""
    return _actuators.Millard2012AccelerationMuscle_getClassName()
...
def McKibbenActuator_getClassName():
    r"""McKibbenActuator_getClassName() -> std::string const &"""
    return _actuators.McKibbenActuator_getClassName()
...
def DeGrooteFregly2016Muscle_getClassName():
    r"""DeGrooteFregly2016Muscle_getClassName() -> std::string const &"""
    return _actuators.DeGrooteFregly2016Muscle_getClassName()

def DeGrooteFregly2016Muscle_getActivationStateName():
    r"""DeGrooteFregly2016Muscle_getActivationStateName() -> std::string"""
    return _actuators.DeGrooteFregly2016Muscle_getActivationStateName()

def DeGrooteFregly2016Muscle_getNormalizedTendonForceStateName():
    r"""DeGrooteFregly2016Muscle_getNormalizedTendonForceStateName() -> std::string"""
    return _actuators.DeGrooteFregly2016Muscle_getNormalizedTendonForceStateName()

def DeGrooteFregly2016Muscle_getImplicitDynamicsDerivativeName():
    r"""DeGrooteFregly2016Muscle_getImplicitDynamicsDerivativeName() -> std::string"""
    return _actuators.DeGrooteFregly2016Muscle_getImplicitDynamicsDerivativeName()

def DeGrooteFregly2016Muscle_getImplicitDynamicsResidualName():
    r"""DeGrooteFregly2016Muscle_getImplicitDynamicsResidualName() -> std::string"""
    return _actuators.DeGrooteFregly2016Muscle_getImplicitDynamicsResidualName()

def DeGrooteFregly2016Muscle_getMinNormalizedTendonForce():
    r"""DeGrooteFregly2016Muscle_getMinNormalizedTendonForce() -> double"""
    return _actuators.DeGrooteFregly2016Muscle_getMinNormalizedTendonForce()

def DeGrooteFregly2016Muscle_getMaxNormalizedTendonForce():
    r"""DeGrooteFregly2016Muscle_getMaxNormalizedTendonForce() -> double"""
    return _actuators.DeGrooteFregly2016Muscle_getMaxNormalizedTendonForce()

def DeGrooteFregly2016Muscle_getMinNormalizedFiberLength():
    r"""DeGrooteFregly2016Muscle_getMinNormalizedFiberLength() -> double"""
    return _actuators.DeGrooteFregly2016Muscle_getMinNormalizedFiberLength()

def DeGrooteFregly2016Muscle_getMaxNormalizedFiberLength():
    r"""DeGrooteFregly2016Muscle_getMaxNormalizedFiberLength() -> double"""
    return _actuators.DeGrooteFregly2016Muscle_getMaxNormalizedFiberLength()
...
def DeGrooteFregly2016Muscle_replaceMuscles(model, allowUnsupportedMuscles=False):
    r"""
    DeGrooteFregly2016Muscle_replaceMuscles(Model model, bool allowUnsupportedMuscles=False)
...
class ModelFactory(object):
    ...
    def createReserveActuators(*args):
        r"""
        createReserveActuators(Model model, double optimalForce, double bound=SimTK::NaN, bool skipCoordinatesWithExistingActuators=True)
...
def ModelFactory_createPendulum():
    r"""ModelFactory_createPendulum() -> Model"""
    return _actuators.ModelFactory_createPendulum()

def ModelFactory_createDoublePendulum():
    r"""ModelFactory_createDoublePendulum() -> Model"""
    return _actuators.ModelFactory_createDoublePendulum()

def ModelFactory_createSlidingPointMass():
    r"""ModelFactory_createSlidingPointMass() -> Model"""
    return _actuators.ModelFactory_createSlidingPointMass()

def ModelFactory_createPlanarPointMass():
    r"""ModelFactory_createPlanarPointMass() -> Model"""
    return _actuators.ModelFactory_createPlanarPointMass()
...
def ModelFactory_createReserveActuators(*args):
    r"""
    ModelFactory_createReserveActuators(Model model, double optimalForce, double bound=SimTK::NaN, bool skipCoordinatesWithExistingActuators=True)
...
def ModelOperator_getClassName():
    r"""ModelOperator_getClassName() -> std::string const &"""
    return _actuators.ModelOperator_getClassName()
...
def ModelProcessor_getClassName():
    r"""ModelProcessor_getClassName() -> std::string const &"""
    return _actuators.ModelProcessor_getClassName()
...
def ModOpIgnoreActivationDynamics_getClassName():
    r"""ModOpIgnoreActivationDynamics_getClassName() -> std::string const &"""
    return _actuators.ModOpIgnoreActivationDynamics_getClassName()
...
def ModOpIgnoreTendonCompliance_getClassName():
    r"""ModOpIgnoreTendonCompliance_getClassName() -> std::string const &"""
    return _actuators.ModOpIgnoreTendonCompliance_getClassName()
...
def ModOpScaleMaxIsometricForce_getClassName():
    r"""ModOpScaleMaxIsometricForce_getClassName() -> std::string const &"""
    return _actuators.ModOpScaleMaxIsometricForce_getClassName()
...
def ModOpRemoveMuscles_getClassName():
    r"""ModOpRemoveMuscles_getClassName() -> std::string const &"""
    return _actuators.ModOpRemoveMuscles_getClassName()
...
def ModOpAddReserves_getClassName():
    r"""ModOpAddReserves_getClassName() -> std::string const &"""
    return _actuators.ModOpAddReserves_getClassName()
...
def ModOpAddExternalLoads_getClassName():
    r"""ModOpAddExternalLoads_getClassName() -> std::string const &"""
    return _actuators.ModOpAddExternalLoads_getClassName()
...
def ModOpReplaceJointsWithWelds_getClassName():
    r"""ModOpReplaceJointsWithWelds_getClassName() -> std::string const &"""
    return _actuators.ModOpReplaceJointsWithWelds_getClassName()
